...
?>
    ...
    <!--END HOME SECTION-->
 <h2 style="margin-left:45%">Admin list</h2>
...
<table style=" margin-left:20%;width:100%">
       ...
       <th  ><b style=" margin-left:30%">Email</b></th>
...
<?php 
echo "<table>";
$result = mysqli_query($db,"SELECT * FROM admin ORDER BY id DESC");
$count=1;
 while($row = mysqli_fetch_array($result))
     {
		 ...
		 $id=$row['id'];
		  ...
		  echo "<td ><a href='deleteadmin.php?id=$id'> Delete</a></td>";
	  ...
	  echo "<td style='text-align:center;width:100%'>" . $row['email'] . "</td>";
         $count++;
echo "</tr>";
	 }   
  echo "</table>"   ;  
