...
?>
    ...
    <section  id="services-sec">
		...
		<br>
		<?php
echo '<a href="realbook.php?id='.$id.'"><button style="background-color:#32CD32;color:white;border:none;border-radius:20px;height:30px;width:150px;margin-left:45%;border:none" type = "submit">Book This Tour</button></a>';
