...
<div id="livesearch"></div>
		  ...
		  for($j=$i-1;$j>=0;$j--){
			  $k=$id[$j];
		  echo '<img style="width:400px;height:150px;margin-left:10%;margin-top:40px", src="data:image/jpeg;base64,'.base64_encode($image[$j]) .'" /> <a href="result.php?id='.$k.'"> <h4 style="display:inline;margin-left:2%;color:#2F4F4F;margin-top:10%">'.$name[$j].'</h4> </a>';
